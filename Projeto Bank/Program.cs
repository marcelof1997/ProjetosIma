...
{
    static void menuPrincipal()                //editando menu ainda
    {
        ...
        do
        {
            do
            {
                ...
                if (opcaoPrincipal == 2)
                {
                    ...
                    menuPrincipal();                                  //Menu principal
                    opcaoPrincipal = int.Parse(Console.ReadLine());
                    Console.WriteLine();                                                      //teste commit 00
                }
                if (opcaoPrincipal == 3)
                {
            ...
            if (opcaoPrincipal == 6)
            {
                ...
                while (cod != 097)                                        //senha de Acesso " 097 "//
                {
                    Console.WriteLine("*Senha incorreta*");
                    Console.Write("*****");
                    cod = int.Parse(Console.ReadLine());
                }
                if (cod == 097) { Console.WriteLine("***\nSenha aceita"); }
                ...
                do
                {
                    ...
                    }       // Area de transferencia ok confirmar depois upgrade //
                    else if (opcao == 3)
                    {
                    ...
                    //Area de Investimentos ok precisando de novas opcoes//
                    else if (opcao == 5)
                    {
